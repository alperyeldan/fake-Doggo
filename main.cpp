...
void postion_16bit(struct LegIdentifier legs[]){
    ...
    int var = 75;//75
    transmit(can_one, legs[0].motorA, motorA_pos, 2047, 10, 250, 2047-var);
    receive(can_one,recieved_A);
    transmit(can_one, legs[0].motorB, motorB_pos, 2047, 10, 250, 2047+var);
...
int main()
{
    ...
    struct GaitParams state_gait_params[3] = {
        ...
        {0.20, 0.03, 0.08, 0.35, 0.4, 1.0, 0.0}, // TROT
